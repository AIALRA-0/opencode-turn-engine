...
export const SortableWorkspace = (props: {
  ...
  const sessions = createMemo(() => sortedRootSessions(workspaceStore, props.sortNow(), workspaceStore.path.directory || props.directory))
...
export const LocalWorkspace = (props: {
  ...
  const sessions = createMemo(() =>
    sortedRootSessions(workspace().store, props.sortNow(), workspace().store.path.directory || props.project.worktree),
  )
  const count = createMemo(() => sessions()?.length ?? 0)
